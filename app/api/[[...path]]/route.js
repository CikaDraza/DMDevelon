...
export async function PUT(request, context) {
  ...
  try {
    ...
    if (pathStr.startsWith("users/")) {
      ...
      // Construct the mutation server-side. Security/session/provenance fields
      // and notification preferences are never copied from this generic
      // profile payload; preferences already have /api/user/settings.
      const update = {};
      ...
      if (body.password !== undefined) {
        ...
        // This value is always derived from stored state. A caller-supplied
        // sessionVersion is ignored even when a real password change occurs.
