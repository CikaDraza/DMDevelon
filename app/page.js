        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-0 min-h-[calc(100vh-80px)] items-stretch">
          ...
          >
            ...
            <motion.div
              ...
              animate="visible"
              variants={bounceIn}
              className="absolute left-1/2 lg:-left-24 bottom-8 lg:bottom-auto lg:top-1/2 transform -translate-x-1/2 lg:translate-x-0 lg:-translate-y-1/2"
            >
              <div className="relative">
                <div className="absolute inset-0 bg-[#FFB633] rounded-full blur-2xl opacity-30 animate-pulse" />
                <img
                  src={PROFILE_PICTURE}
                  alt="Milan Drazic"
                  className="w-32 h-32 lg:w-48 lg:h-48 rounded-full border-4 border-[#FFB633] object-cover relative z-10"
                />
              </div>
            </motion.div>
          </motion.div>
