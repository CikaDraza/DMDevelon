  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#0f0f10]/90 backdrop-blur-lg shadow-lg"
          : "bg-transparent"
      }`}
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-logo text-xl font-bold text-white tracking-wider">
                DMDevelon
              </h1>
  ...
  return (
    <section id="hero" className="section-full relative overflow-hidden pt-20">
      <div className="container mx-auto px-4 h-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-0 min-h-[calc(100vh-80px)] items-stretch relative">
          {/* Left Column */}
          <motion.div
            initial="hidden"
            animate="visible"
            variants={fadeInLeft}
            className="lg:col-span-2 glass rounded-l-2xl lg:rounded-r-none rounded-t-2xl lg:rounded-t-none lg:rounded-tl-2xl lg:rounded-bl-2xl flex flex-col justify-center p-8 lg:p-12"
          >
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-[#2C2C2C] rounded-r-2xl lg:rounded-l-none rounded-b-2xl lg:rounded-b-none lg:rounded-tr-2xl lg:rounded-br-2xl flex flex-col justify-center p-8 lg:p-12 relative -z-10"
          >
...
function ServicesSection({ services }) {
  ...
  const defaultServices = [
    ...
    },
    {
      _id: "2",
      title: "UI/UX Design",
      description: "Beautiful, intuitive user interfaces that delight users",
      icon: "Palette",
      color: "purple",
      gridSpan: 2,
    },
...
function ProjectsSection({ projects }) {
  ...
  const displayProjects =
    filteredProjects.length > 0 ? filteredProjects : defaultProjects;
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden px-8">
            <motion.div
              ...
              className="flex gap-6"
              style={{
                width: `${(displayTestimonials.length / itemsPerView) * 100}%`,
              }}
            >
