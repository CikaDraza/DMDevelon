...
export const emailTemplates = {
  ...
  contactNotification: (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #FFB633;">New Contact Form Message</h2>
  ...
  emailVerification: (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #FFB633;">Welcome to DM Develon!</h2>
        <p>Hi ${data.name},</p>
  ...
  contactReply: (data) => ({
    subject: "Re: Your message to DM Develon",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <header style="background: #0a0a0b; padding: 20px; text-align: center;">
          <h1 style="color: #FFB633; margin: 0;">DM Develon</h1>
        </header>
