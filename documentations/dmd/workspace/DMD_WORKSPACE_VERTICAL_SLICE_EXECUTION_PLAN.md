...
**Status:** ACTIVE
**Authority:** companion
**Owner domain:** Workspace / Execution
**Supersedes:** compact milestone-ID reuse in the archived client flow
**Superseded by:** —

**Date:** 2026-09-12
**Execution authority:** [`documentations/TODO.md`](../../TODO.md) is the canonical milestone, dependency and completion-status authority. This companion does not maintain an independent status tracker.
