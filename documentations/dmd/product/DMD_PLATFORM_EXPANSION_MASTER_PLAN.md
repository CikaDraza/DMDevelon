...
**Status:** ACTIVE
**Authority:** canonical
**Owner domain:** DMD Product / Lifecycle
**Supersedes:** —
**Superseded by:** —

**Date:** 2026-09-09
**Last updated:** 2026-09-12
**Foundation:** `documentations/dmd/domains/design/DMD_DESIGN_ENGINE_PRINCIPLES.md`
**Authority note:** This file is the single canonical lifecycle and product guidance for the platform expansion. [`DMD_CURRENT_APP_AUDIT_ADDENDUM.md`](../audits/current-system/DMD_CURRENT_APP_AUDIT_ADDENDUM.md) is evidence-only, not a second master plan.
**Execution index:** [`documentations/TODO.md`](../../TODO.md) owns milestone IDs (`DMD-FND-*`, `DMD-WS-*`, `DMD-BI-*`, `DMD-PI-*`, `DMD-DES-*`, `DMD-COM-*`, `DMD-PROJECT-*`, `DMD-CONV-*`), dependencies and completion status. The M0–M12 roadmap in §7 below is the earlier planning numbering and is not a competing execution index.
...
- `documentations/dmd/product/DMD_CLIENT_WORKSPACE_PRODUCT_DIRECTION.md`
- `documentations/dmd/domains/business-intelligence/DMD_BUSINESS_INTELLIGENCE_DISCOVERY.md`
- `documentations/dmd/domains/product-intelligence/DMD_PRODUCT_INTELLIGENCE_ROUTING_BLUEPRINT.md`
- `documentations/dmd/domains/design/DMD_DESIGN_ENGINE_CLIENT_FLOW.md`
- `documentations/dmd/domains/commercial/DMD_COMMERCIAL_PROVISIONING.md`
- `documentations/dmd/domains/project-intelligence/DMD_PROJECT_INTELLIGENCE.md`
- planned, not yet authored: `DMD_EVIDENCE_KNOWLEDGE_INTEGRATIONS.md`
- planned, not yet authored: `DMD_IMPLEMENTATION_MILESTONES_TASKS.md`

Foundation koji ostaje važeći:

- `documentations/dmd/domains/design/DMD_DESIGN_ENGINE_PRINCIPLES.md`
